/**
 * Finnish translation bundle mapping the editor's UI string keys to their Finnish text. Loaded by the localization layer to render the interface in Finnish.
 */
...
const locale = {
  ...
  'editor.upload.fileSizeTooBig':
    '{fileName}-tiedosto liian suuri, suurin sallittu koko on {size}MB',
