...
export const DEFAULT_FONT_FAMILY_LIST = [
  ...
  'Monaco',
  // 'monospace',
  // Microsoft Office / Windows font alternatives
  // { name: 'Arimo (Arial alternative)', value: 'Arimo' },
  { name: 'Cambria', value: 'Caladea' },
  { name: 'Calibri', value: 'Carlito' },
  // { name: 'Cousine (Courier New alternative)', value: 'Cousine' },
  // { name: 'Tinos (Times New Roman alternative)', value: 'Tinos' },
  // Google Fonts
  'Afacad Flux',
  'Alegreya',
  'Garamond',
