...
export const sharedMainAreaChildren: RouteObject[] = [
  // QwkSearch Docs: Markdown research documents stored in D1 (see features/QwkSearch/Docs).
  {
    children: [
      {
        element: dynamicElement(() => import('@/routes/(main)/docs'), 'Desktop > QwkSearch Docs'),
        handle: { meta: qwkDocsRouteMeta },
        index: true,
      },
      {
        element: dynamicElement(
          () => import('@/routes/(main)/docs/[docId]'),
          'Desktop > QwkSearch Docs > Document',
        ),
        handle: { meta: qwkDocsRouteMeta },
        path: ':docId',
      },
