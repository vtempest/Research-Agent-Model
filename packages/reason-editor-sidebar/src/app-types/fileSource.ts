/**
 * @module app-types/fileSource
 * @description TypeScript types for all supported file-source providers:
 * SSH, S3, R2, B2, Google Docs, Turso DB, and the AnyFileSource union.
 */
