/**
 * Simplified Chinese translation bundle mapping the editor's UI string keys to their Simplified Chinese text. Loaded by the localization layer to render the interface in Simplified Chinese.
 */
