/**
 * Reusable popover UI primitive (shadcn/Radix style) styled with the editor's Tailwind classes. Shared across the editor for consistent popover rendering.
 */
...
/** Anchors a popover to an element other than its trigger (used by Plate's table/media/column controls). */
