/**
 * Vietnamese translation bundle mapping the editor's UI string keys to their Vietnamese text. Loaded by the localization layer to render the interface in Vietnamese.
 */
...
const locale = {
  ...
  'editor.upload.fileSizeTooBig':
    '{fileName} kích thước tệp quá lớn, kích thước tối đa là {size}MB',
