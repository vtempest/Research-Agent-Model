/**
 * Japanese translation bundle mapping the editor's UI string keys to their Japanese text. Loaded by the localization layer to render the interface in Japanese.
 */
