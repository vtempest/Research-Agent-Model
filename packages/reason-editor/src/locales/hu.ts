/**
 * Hungarian translation bundle mapping the editor's UI string keys to their Hungarian text. Loaded by the localization layer to render the interface in Hungarian.
 */
