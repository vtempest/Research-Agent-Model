/**
 * English translation bundle mapping the editor's UI string keys to their English text. Loaded by the localization layer to render the interface in English.
 */
