/**
 * Floating bubble menu shown when a katex element is selected in the editor. Presents contextual formatting and actions inline near the selection.
 */
...
function ModalEditKatex({ children, visible, toggleVisible }: any) {
  ...
  }, [currentValue, currentMacros, katexLib]);
