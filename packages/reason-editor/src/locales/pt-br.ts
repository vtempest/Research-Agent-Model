/**
 * Brazilian Portuguese translation bundle mapping the editor's UI string keys to their Brazilian Portuguese text. Loaded by the localization layer to render the interface in Brazilian Portuguese.
 */
