/**
 * Toolbar control (React) for the Mermaid extension, which adds Mermaid diagrams. Renders the button and dispatches the matching editor command when activated.
 */
