/**
 * Reusable select/combobox UI primitive (shadcn/Radix style) styled with the editor's Tailwind classes. Shared across the editor for consistent select/combobox rendering.
 */
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className='richtext-size-4 richtext-opacity-50' />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUp className='richtext-size-4' />
  </SelectPrimitive.ScrollUpButton>
));
